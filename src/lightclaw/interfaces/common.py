...
from lightclaw.application.services.config_service import hydrate_settings_from_runtime_config
...
def create_interface_context(settings: AppSettings | None = None) -> tuple[AppSettings, ApplicationContainer]:
    ...
    resolved_settings = hydrate_settings_from_runtime_config(resolved_settings)

        ...
        await container.config_service.save_console_config(
            {
                ...
                "browser_allowed_domains": payload.browser_allowed_domains,
                "browser_allow_persistent_auth": payload.browser_allow_persistent_auth,
                "browser_profile_root": payload.browser_profile_root,
                "mail_web_provider": payload.mail_web_provider,
                "weather_url_template": payload.weather_url_template,
